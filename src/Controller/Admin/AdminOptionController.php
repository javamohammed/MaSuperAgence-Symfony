...
class AdminOptionController extends AbstractController
{
    ...
    {
        return $this->render('property/admin/option/index.html.twig', ['options' => $optionRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('property/admin/option/new.html.twig', [
            'option' => $option,
    ...
    public function edit(Request $request, Option $option): Response
    {
        ...
        return $this->render('property/admin/option/edit.html.twig', [
            'option' => $option,
            'form' => $form->createView(),
        ]);
    }
